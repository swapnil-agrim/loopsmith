...
-- guardrail line above and this is ordinary file commentary, not part of guardrail. See
-- insight/metrics/header.py's module docstring for the full reasoning.
