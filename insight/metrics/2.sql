...
SELECT
    ...
    excl.excluded_negative_duration_count
FROM fact_goal
CROSS JOIN (
    SELECT count(*) AS excluded_negative_duration_count
    FROM fact_goal
