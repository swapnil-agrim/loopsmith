 ...
 *  ROLE_ROUTES["cross-functional"] today; ROLE_ROUTES.manager was this example until #313
 *  [E20.S2] built its page, and ROLE_ROUTES.leadership until #314 [E20.S3] built this one) is
 *  never emitted, which is what keeps nav free of dead links to E20
